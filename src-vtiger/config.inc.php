...
$HELPDESK_SUPPORT_EMAIL_ID = 'dummy@example.com';
...
$dbconfig['db_server']   = getenv('db_server');    //'localhost';
$dbconfig['db_port']     = getenv('db_port');     //':3306';
$dbconfig['db_username'] = getenv('db_username'); //'vtigerdemo';
$dbconfig['db_password'] = getenv('db_password'); //'vtigerdemo';
$dbconfig['db_name']     = getenv('db_name');     //'vtigerdemo';
